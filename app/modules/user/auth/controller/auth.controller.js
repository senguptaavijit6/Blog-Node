...
class UserAuthController {
    registerPage(req, res) {
        try {
            return res.render("auth/user/registerPage", { title: "Register page for user", timezones: timezones.default })
        } catch (error) {
    ...
    async register(req, res) {
        try {
            ...
            const mailObj = {
                to: req.body.email,
                subject: "Verification Email from TechBlog",
    ...
    verifyEmailPage(req, res) {
        try {
            ...
            return res.render("auth/user/emailVerificationPage", { title: "Email verification for user", userEmail, fallback })
        } catch (error) {
    ...
    loginPage(req, res) {
        try {
            return res.render("auth/user/loginPage", { title: "Login page for user" })
        } catch (error) {
    ...
    async changePasswordUsingOTPPage(req, res) {
        try {
            ...
            return res.render("auth/user/changePasswordUsingOTPPage", { title: "Change password page for user", user: isEmailExists, userOTP: req.params.otp })
        } catch (error) {
    ...
    accountSettingsPage(req, res) {
        try {
            ...
            return res.render("pages/user/settingsPage", { title: "Settings page for user", user })
        } catch (error) {
            console.error("user settingsPage controller error", error);
        }
    }

    siteSettingsPage(req, res) {
        try {
            const user = req.user
            console.log("user", user);
            if (!user) {
            ...
            return res.render("pages/user/siteSettingsPage", { title: `Update details of ${user.role}`, user, timezones: timezones.default })
        } catch (error) {
    ...
    updateDetailsPage(req, res) {
        try {
            ...
            return res.render("pages/user/updateDetailsPage", { title: `Update details of ${user.role}`, user })
        } catch (error) {
    ...
    verifyEmailToUpdateDetailsPage(req, res) {
        try {
            const user = req.user
            console.log("user", user);
            ...
            return res.render("auth/user/verifyEmailToUpdateDetailsPage", { title: "Change details page for user", user })
        } catch (error) {
    ...
    changePasswordUsingPasswordPage(req, res) {
        try {
            const user = req.user
            console.log("user", user);
            return res.render("auth/user/changePasswordUsingPasswordPage", { title: "Change password page for user", user })
        } catch (error) {
            console.error("user changePasswordPage controller error", error);
        }
    }
    ...
    changeImagePage(req, res) {
        try {
            const user = req.user
            console.log("user", user);
            return res.render("pages/user/changeImagePage", { title: "Change image page for user", user })
        } catch (error) {
    ...
    forgotPasswordPage(req, res) {
        try {
            return res.render("auth/user/forgotPasswordPage", { title: "Forgot password page for user" })
        } catch (error) {
    ...
    async forgotPasswordOTPPage(req, res) {
        try {
            ...
            console.log("saved user otp", saveToUserOtp);
            return res.render("auth/user/forgotPasswordOTPPage", { title: "Forgot password OTP verification page for user", userEmail: req.body.email })
        } catch (error) {
    ...
    async forgotPasswordOTPVerification(req, res) {
        try {
            ...
            return res.render("auth/user/changePassOrLoginPage", { title: "Change password or Login page for user", user: isEmailExists, userOTP: req.body.otp })
        } catch (error) {
