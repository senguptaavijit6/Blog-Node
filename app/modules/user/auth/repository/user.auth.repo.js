...
class UserAuthRepo {
    ...
    async createUser(user) {
        try {
            ...
            return UserModel.create(freshUser)
        } catch (error) {
    ...
    async searchByEmailAndSelect(email, select) {
        try {
            return UserModel.findOne({ email: email }).select(select)
        } catch (error) {
    ...
    async updateUserDetails(userId, details) {
        try {
            ...
            return UserModel.findOneAndUpdate({ _id: userId }, {...details})
        } catch (error) {
    ...
    async updateUserAvatar(email, avatar) {
        try {
            return UserModel.findOneAndUpdate({ email: email }, { avatar: avatar })
        } catch (error) {
    ...
    async updateUserOTP(email, otp) {
        try {
            return UserModel.findOneAndUpdate({ email: email }, { otp: otp })
        } catch (error) {
