...
class FAQController {
    ...
    createFAQPage(req, res) {
        try {
            ...
            return res.render("pages/faq/createFAQPage", {title: "All FAQs", user})
        } catch (error) {
    ...
    async retrieveAllFAQsPage(req, res) {
        try {
            ...
            return res.render("pages/faq/allFAQsPage", {title: "All FAQs", user, faqData})
    ...
    async retrieveSingleFAQ(req, res) {
        try {
            ...
            return res.render("pages/faq/singleFAQ", { title: "FAQ Details Page", user, FAQ })
        } catch (error) {
    ...
    async updateFAQPage(req, res) {
        try {
            ...
            return res.render("pages/faq/updateFAQPage", { title: "FAQ update page", user, FAQData })
        } catch (error) {
