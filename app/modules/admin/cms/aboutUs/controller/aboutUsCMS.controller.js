...
class AboutUsCMSController {
    /* aboutUsCMSPage(req, res) {
        try {
            ...
            return res.render("pages/cms/aboutUsCMSPage", {title: "CMS About Us page", user})
        } catch (error) {
    ...
    async createOrUpdateAboutUsCMSPage(req, res) {
        try {
            ...
            if (aboutUsData) {
                return res.render("pages/cms/aboutUsCMSPage", { title: "CMS About Us page", user, aboutUsData })
            }
