...
class HomepageCMSController {
    async createOrUpdatePage(req, res) {
        try {
            ...
            return res.render("pages/cms/homeCMSPage", { title: "Home Page CMS", user, homepageData, allTags })
        } catch (error) {
    ...
    async retrieveHomeSliderPage(req, res) {
        try {
            ...
            return res.render("pages/cms/slider/allHomeSliderPage", { title: "Home Slider CMS", user, sliderData })
        } catch (error) {
    ...
    async retrieveHomeSingleSliderPage(req, res) {
        try {
            ...
            return res.render("pages/cms/slider/singleHomeSliderPage", { title: "Create Home Page Slider CMS", user, sliderData})
    ...
    async createHomeSliderPage(req, res) {
        try {
            ...
            return res.render("pages/cms/slider/createHomeSliderPage", { title: "Create Home Page Slider CMS", user})
    ...
    async updateHomeSliderPage(req, res) {
        try {
            ...
            return res.render("pages/cms/slider/updateHomeSliderPage", { title: "Update Home Page Slider CMS", user, sliderData})
        } catch (error) {
