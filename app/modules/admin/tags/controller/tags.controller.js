...
class TagsController {
    ...
    createTagPage(req, res) {
        try {
            ...
            return res.render("pages/tags/createTagPage", {title: "Create Tag", user})
        } catch (error) {
    ...
    async retrieveAllTagsPage(req, res) {
        try {
            ...
            return res.render("pages/tags/allTagsPage", {title: "All Tags", user, TagData})
    ...
    async retrieveSingleTag(req, res) {
        try {
            ...
            return res.render("pages/tags/singleTagPage", { title: "Tag Details Page", user, Tag })
        } catch (error) {
    ...
    async updateTagPage(req, res) {
        try {
            ...
            return res.render("pages/tags/updateTagPage", { title: "Tag update page", user, TagData })
        } catch (error) {
