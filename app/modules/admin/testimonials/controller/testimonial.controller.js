...
class TestimonialController {
    ...
    createTestimonialPage(req, res) {
        try {
            ...
            return res.render("pages/testimonial/createTestimonialPage", {title: "All Testimonials", user})
        } catch (error) {
    ...
    async retrieveAllTestimonialsPage(req, res) {
        try {
            ...
            return res.render("pages/testimonial/allTestimonialsPage", {title: "All Testimonials", user, testimonialsData})
    ...
    async retrieveSingleTestimonial(req, res) {
        try {
            ...
            return res.render("pages/testimonial/singleTestimonial", { title: "Testimonial Details Page", user, Testimonial })
        } catch (error) {
    ...
    async updateTestimonialPage(req, res) {
        try {
            ...
            return res.render("pages/testimonial/updateTestimonialPage", { title: "Testimonial update page", user, TestimonialData })
        } catch (error) {
