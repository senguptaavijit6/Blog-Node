...
class CategoryController {
    ...
    createCategoryPage(req, res) {
        try {
            ...
            return res.render("pages/category/createCategoryPage", {title: "Create Category", user})
        } catch (error) {
    ...
    async retrieveAllCategoriesPage(req, res) {
        try {
            ...
            return res.render("pages/category/allCategoriesPage", {title: "All Categories", user, categoryData})
    ...
    async retrieveSingleCategory(req, res) {
        try {
            ...
            return res.render("pages/category/singleCategory", { title: "Category Details Page", user, Category })
        } catch (error) {
    ...
    async updateCategoryPage(req, res) {
        try {
            ...
            return res.render("pages/category/updateCategoryPage", { title: "Category update page", user, CategoryData })
        } catch (error) {
