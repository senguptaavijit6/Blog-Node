...
class AdminAuthController {
    registerPage(req, res) {
        try {
            return res.render("auth/admin/registerPage", { title: "Register page for admin", timezones: timezones.default })
        } catch (error) {
    ...
    verifyEmailPage(req, res) {
        try {
            ...
            return res.render("auth/admin/emailVerificationPage", { title: "Email verification for admin", userEmail, fallback })
        } catch (error) {
    ...
    loginPage(req, res) {
        try {
            return res.render("auth/admin/loginPage", { title: "Login page for admin" })
        } catch (error) {
    ...
    async changePasswordUsingOTPPage(req, res) {
        try {
            ...
            return res.render("auth/admin/changePasswordUsingOTPPage", { title: "Change password page for admin", user: isEmailExists, userOTP: req.params.otp })
        } catch (error) {
    ...
    accountSettingsPage(req, res) {
        try {
            ...
            return res.render("pages/admin/settingsPage", { title: "Settings page for admin", user: user })
        } catch (error) {
    ...
    siteSettingsPage(req, res) {
        try {
            ...
            return res.render("pages/admin/siteSettingsPage", { title: `Update details of ${user.role}`, user, timezones: timezones.default })
        } catch (error) {
    ...
    updateDetailsPage(req, res) {
        try {
            ...
            return res.render("pages/admin/updateDetailsPage", { title: `Update details of ${user.role}`, user })
        } catch (error) {
    ...
    verifyEmailToUpdateDetailsPage(req, res) {
        try {
            ...
            return res.render("auth/admin/verifyEmailToUpdateDetailsPage", { title: "Change details page for admin", user })
        } catch (error) {
    ...
    changePasswordUsingPasswordPage(req, res) {
        try {
            const user = req.user
            console.log("user", user);
            return res.render("auth/admin/changePasswordUsingPasswordPage", { title: "Change password page for admin", user })
        } catch (error) {
            console.error("admin changePasswordPage controller error", error);
        }
    }
    ...
    changeImagePage(req, res) {
        try {
            const user = req.user
            console.log("user", user);
            return res.render("pages/admin/changeImagePage", { title: "Change image page for admin", user })
        } catch (error) {
    ...
    forgotPasswordPage(req, res) {
        try {
            return res.render("auth/admin/forgotPasswordPage", { title: "Forgot password page for admin" })
        } catch (error) {
    ...
    async forgotPasswordOTPPage(req, res) {
        try {
            ...
            console.log("saved admin otp", saveToAdminOtp);
            return res.render("auth/admin/forgotPasswordOTPPage", { title: "Forgot password OTP verification page for admin", userEmail: req.body.email })
        } catch (error) {
    ...
    async forgotPasswordOTPVerification(req, res) {
        try {
            ...
            return res.render("auth/admin/changePassOrLoginPage", { title: "Change password or Login page for admin", user: isEmailExists, userOTP: req.body.otp })
        } catch (error) {
